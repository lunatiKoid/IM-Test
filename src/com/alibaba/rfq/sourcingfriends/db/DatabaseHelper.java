...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS USER_PROFILE_SF (" + "USER_ID INTEGER PRIMARY KEY AUTOINCREMENT, "
                   ...
                   + "ADDRESS VARCHAR(50)," + "MINI_SITE VARCHAR(50)," + "ADDED LONG," + "MAIN_PRODUCTS VARCHAR(50),"
                   + "RECENTLY_QUOTED_B_REQUEST VARCHAR(50));");
        db.execSQL("CREATE TABLE IF NOT EXISTS TRADE_MSG_SF(" + "TRADE_MSG_ID INTEGER PRIMARY KEY AUTOINCREMENT,"
                   ...
                   + "LASTED_MSG_CONTENT VARCHAR(333)," + "MSG_RECEIVER_NAME VARCHAR(20)," + "MSG_UNREAD_NUM INTEGER ,"
                   + "LASTED_MSG_RECEIVED_TIME LONG);");
        db.execSQL("CREATE TABLE IF NOT EXISTS ING_MSG_SF(" + "ING_MSG_ID INTEGER PRIMARY KEY AUTOINCREMENT,"
                   + "MSG_SENDER_ID INTEGER," + "PHOTO BLOB," + " MSG_SENDER_NAME VARCHAR(20),"
                   + "MSG_SENDED_TIME LONG," + "MSG_CONTENT VARCHAR(333)," + "MSG_IN_OR_OUT VARCHAR(5),"
                   + "MSG_RECEIVER_NAME VARCHAR(20)," + "MSG_RECEIVED_TIME LONG);");
