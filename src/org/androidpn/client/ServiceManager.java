...
public final class ServiceManager {
    ...
    public ServiceManager(Context context, Properties props ) {
        ...
        xmppHost = properties.getProperty("xmppHost", "127.0.0.1");
        xmppPort = properties.getProperty("xmppPort", "5222");
        Log.i(LOGTAG, "apiKey=" + apiKey);
...
//        }
        ...
        Log.i("ServiceManager",properties.toString());
